...
var temp1Vector3 = new _three.Vector3(),
    temp2Vector3 = new _three.Vector3(),
    temp1Matrix4 = new _three.Matrix4(),
    temp1Quat = new _three.Quaternion();

var getEulerXYZFromQuaternion = function getEulerXYZFromQuaternion(x, y, z, w) {
  return new _three.Vector3(Math.atan2(2 * (x * w - y * z), w * w - x * x - y * y + z * z), Math.asin(2 * (x * z + y * w)), Math.atan2(2 * (z * w - x * y), w * w + x * x - y * y - z * z));
};
