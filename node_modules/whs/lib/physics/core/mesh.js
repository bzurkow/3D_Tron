...
var Mesh = exports.Mesh = function (_MeshNative) {
  (0, _inherits3.default)(Mesh, _MeshNative);
  ...
  function Mesh(geometry, material, mass) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Mesh.__proto__ || (0, _getPrototypeOf2.default)(Mesh)).call(this, geometry, material));
    ...
    _this._physijs = {
      ...
      mass: mass || 0,
      touches: [],
      linearVelocity: new _three.Vector3(),
      angularVelocity: new _three.Vector3(),
      group: params.group,
      mask: params.mask
    };
    return _this;
