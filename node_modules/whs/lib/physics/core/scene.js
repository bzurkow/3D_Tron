...
var Scene = exports.Scene = function (_SceneNative) {
  (0, _inherits3.default)(Scene, _SceneNative);
  ...
  function Scene() {
    ...
    if (_this._stats) {
      ...
      _this._world.$element.appendChild(_this._stats.domElement);
    }
    return _this;
  }
  ...
  (0, _createClass3.default)(Scene, [{
    ...
    value: function addConstraint(constraint, show_marker) {
      ...
      if (show_marker) {
        ...
        switch (constraint.type) {
          case 'point':
            marker = new _three.Mesh(new _three.SphereGeometry(1.5), new _three.MeshNormalMaterial());
          ...
          case 'slider':
            marker = new _three.Mesh(new _three.BoxGeometry(10, 1, 1), new _three.MeshNormalMaterial());
    ...
    value: function add(object) {
      _three.Mesh.prototype.add.call(this, object);
    ...
    value: function remove(object) {
      if (object instanceof _vehicle.Vehicle) {
        ...
        _three.Mesh.prototype.remove.call(this, object);
