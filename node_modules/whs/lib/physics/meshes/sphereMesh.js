...
var SphereMesh = exports.SphereMesh = function (_Mesh) {
    ...
    function SphereMesh(geometry, material) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (SphereMesh.__proto__ || (0, _getPrototypeOf2.default)(SphereMesh)).call(this, geometry, material, mass, physParams));
