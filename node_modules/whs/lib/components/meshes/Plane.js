...
var Plane = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  ...
  function Plane() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Plane.__proto__ || (0, _getPrototypeOf2.default)(Plane)).call(this, params, Plane.defaults, Plane.instructions));

    if (params.build) {
      _this.build(params);
      (0, _get3.default)(Plane.prototype.__proto__ || (0, _getPrototypeOf2.default)(Plane.prototype), 'wrap', _this).call(_this);
    }
    return _this;
  }
