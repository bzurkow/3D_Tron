...
var Sphere = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  ...
  function Sphere() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Sphere.__proto__ || (0, _getPrototypeOf2.default)(Sphere)).call(this, params, Sphere.defaults, Sphere.instructions));

    if (params.build) {
      _this.build(params);
      (0, _get3.default)(Sphere.prototype.__proto__ || (0, _getPrototypeOf2.default)(Sphere.prototype), 'wrap', _this).call(_this);
    }
    return _this;
  }
