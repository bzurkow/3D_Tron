...
var Extrude = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  ...
  function Extrude() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Extrude.__proto__ || (0, _getPrototypeOf2.default)(Extrude)).call(this, params, Extrude.defaults, Extrude.instructions));

    if (params.build) {
      _this.build(params);
      (0, _get3.default)(Extrude.prototype.__proto__ || (0, _getPrototypeOf2.default)(Extrude.prototype), 'wrap', _this).call(_this);
    }
    return _this;
  }
