...
var Dodecahedron = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  ...
  function Dodecahedron() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Dodecahedron.__proto__ || (0, _getPrototypeOf2.default)(Dodecahedron)).call(this, params, Dodecahedron.defaults, Dodecahedron.instructions));

    if (params.build) {
      _this.build(params);
      (0, _get3.default)(Dodecahedron.prototype.__proto__ || (0, _getPrototypeOf2.default)(Dodecahedron.prototype), 'wrap', _this).call(_this);
    }
    return _this;
  }
