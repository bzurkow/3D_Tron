...
var Tetrahedron = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  ...
  function Tetrahedron() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Tetrahedron.__proto__ || (0, _getPrototypeOf2.default)(Tetrahedron)).call(this, params, Tetrahedron.defaults, Tetrahedron.instructions));

    if (params.build) {
      _this.build(params);
      (0, _get3.default)(Tetrahedron.prototype.__proto__ || (0, _getPrototypeOf2.default)(Tetrahedron.prototype), 'wrap', _this).call(_this);
    }
    return _this;
  }
