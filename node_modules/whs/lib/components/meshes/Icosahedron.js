...
var Icosahedron = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  ...
  function Icosahedron() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Icosahedron.__proto__ || (0, _getPrototypeOf2.default)(Icosahedron)).call(this, params, Icosahedron.defaults, Icosahedron.instructions));

    if (params.build) {
      _this.build(params);
      (0, _get3.default)(Icosahedron.prototype.__proto__ || (0, _getPrototypeOf2.default)(Icosahedron.prototype), 'wrap', _this).call(_this);
    }
    return _this;
  }
