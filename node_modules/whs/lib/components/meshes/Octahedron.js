...
var Octahedron = (0, _SoftbodyComponent.SoftbodyComponent)(_class = (0, _PhysicsComponent.PhysicsComponent)(_class = (0, _MeshComponent.MeshComponent)(_class = (_temp = _class2 = function (_Component) {
  ...
  function Octahedron() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (Octahedron.__proto__ || (0, _getPrototypeOf2.default)(Octahedron)).call(this, params, Octahedron.defaults, Octahedron.instructions));

    if (params.build) {
      _this.build(params);
      (0, _get3.default)(Octahedron.prototype.__proto__ || (0, _getPrototypeOf2.default)(Octahedron.prototype), 'wrap', _this).call(_this);
    }
    return _this;
  }
