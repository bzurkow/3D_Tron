...
var Shape = function (_CoreObject) {
  ...
  function Shape() {
    ...
    if (params instanceof THREE.Object3D) {
      (0, _get3.default)(Shape.prototype.__proto__ || Object.getPrototypeOf(Shape.prototype), 'setParams', _this).call(_this, {
    ...
    } else (0, _get3.default)(Shape.prototype.__proto__ || Object.getPrototypeOf(Shape.prototype), 'setParams', _this).call(_this, params);
